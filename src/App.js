...
const App = () => {
  ...
  // paises con sus nombre, vamos agruparlos en continentes, vamos a traer la informacion paises (nombre, bandera, poblacion) y conectarnos con google maps para mostrar la ubicacion de los paises
  useEffect(() => {
